...
<body>
    <div class="container">
        ...
        <script>
            // Function to retrieve the total price and product details from the query parameters
            function getDetailsFromQuery() {
                ...
                if (products) {
                    ...
                    productArray.forEach(product => {
                        ...
                        listItem.innerHTML = `<span class="fw-bold">Product:</span> <span class="c-green">${name}</span><br>
                                          <span class="fw-bold">Price:</span> <span class="c-green">$${price}</span>`;
                        document.getElementById('product-summary').appendChild(listItem);
                    });
                }
            }
