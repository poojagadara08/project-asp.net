...
{
    public partial class shop6 : Page
    {
        ...
        protected void btnAddToCart_Click(object sender, EventArgs e)
        {
            ...
            {
                ProductId = 6, // Unique ID for the product
                Name = "Chroma Square", // Product name
                Color = "Color: Transparent X Brown", // Product color
                Price = 40.00m, // Product price
                Quantity = 1, // Default quantity
                ImageUrl = "images/g-6.png" // Path to the product image
            };
        ...
        protected void btnBuyNow_Click(object sender, EventArgs e)
        {
            ...
            int productId = 6; // Replace with actual product ID
            string productName = "Chroma Square"; // Replace with actual product name
            string color = "Transparent X Brown";
            decimal productPrice = 40m; // Replace with actual product price
