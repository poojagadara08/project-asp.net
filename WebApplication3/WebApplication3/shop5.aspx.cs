...
{
    public partial class shop5 : Page
    {
        ...
        protected void btnAddToCart_Click(object sender, EventArgs e)
        {
            ...
            {
                ProductId = 5, // Unique ID for the product
                Name = "Luminescence", // Product name
                Color = "Color: Transparent X Peach", // Product color
                Price = 90.00m, // Product price
                Quantity = 1, // Default quantity
                ImageUrl = "images/g-5.png" // Path to the product image
            };
        ...
        protected void btnBuyNow_Click(object sender, EventArgs e)
        {
            ...
            int productId = 5; // Replace with actual product ID
            string productName = "Luminescence"; // Replace with actual product name
            string color = "Transparent X Peach";
            decimal productPrice = 90m; // Replace with actual product price
