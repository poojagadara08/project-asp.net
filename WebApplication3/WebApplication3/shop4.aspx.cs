...
{
    public partial class shop4 : Page
    {
        ...
        protected void btnAddToCart_Click(object sender, EventArgs e)
        {
            ...
            {
                ProductId = 4, // Unique ID for the product
                Name = "Noir Black Square Blue Screen Glasses", // Product name
                Color = "color: transparent x black", // Product color
                Price = 80.00m, // Product price
                Quantity = 1, // Default quantity
                ImageUrl = "images/g-4.png" // Path to the product image
            };
        ...
        protected void btnBuyNow_Click(object sender, EventArgs e)
        {
            ...
            int productId = 4; // Replace with actual product ID
            string productName = "Noir Black Square Blue Screen Glasses"; // Replace with actual product name
            string color = "transparent x black";
            decimal productPrice = 80m; // Replace with actual product price
